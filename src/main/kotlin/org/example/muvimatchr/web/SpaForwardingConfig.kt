...
// D-04's four SPA deep-link routes, forwarded to the React SPA's shell. Registers exactly these
// four literal patterns -- no wildcard or regex path-variable pattern is added here, since that
